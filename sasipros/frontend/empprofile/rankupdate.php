...
$rankid = $_GET["paramterconfigauth"];
$email = $_SESSION["email"];
@$name = $_SESSION["name"];
$details_of_emp = "select *from ranks where Param='$rankid'";
$execute_query = mysqli_query($connection, $details_of_emp);
$details_row = mysqli_fetch_array($execute_query);
@$emp_deg = $details_row['Rtype'];
@$emp_uni = $details_row['Rcoll'];
@$emp_coll = $details_row['Rdate'];
@$emp_stat = $details_row['Rdes'];
  ...
  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../../frontend/dashboard">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="404.html">Form-B</a>
            <a class="collapse-item" href="blank.html">Form-C</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Your Qualification Information</h4>
                  <div class="text-end">
                  ...
                  <p class="card-description">
                    Personal Qualification Updation
                  </p>
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" value="<?php echo $emp_uni; ?>" id="upuni" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input class="form-control" placeholder="dd/mm/yyyy" type="text" value="<?php echo $emp_stat; ?>" id="upstat" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">YOP</label>
                        <div class="col-sm-9">
                          <input class="form-control" placeholder="dd/mm/yyyy" type="date" value="<?php echo $emp_yop; ?>" id="upyop" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <button style="color: white;" class="btn btn-primary" onclick="update()" id="hide">Update</button>
                      </div>
                    </div>
                  </div>
                </div>
