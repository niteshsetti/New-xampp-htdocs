...
@$name = $_SESSION["name"];
$details_of_emp = "select *from qualifications where Param='$quaid'";
$execute_query = mysqli_query($connection, $details_of_emp);
$details_row = mysqli_fetch_array($execute_query);
@$emp_deg = $details_row['Deg'];
@$emp_uni = $details_row['University'];
@$emp_coll = $details_row['College'];
@$emp_stat = $details_row['State'];
@$emp_clas = $details_row['Clas'];
@$emp_yop = $details_row['Yop'];
