                    ...
                    <form action="addimage.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Upload Your Profile Picture</h4>
                                        <p class="card-description">
                                            (Profile should be in . jpg . jpeg . png . svg )
                                        </p>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="custom-file mb-3">
                                                    <input type="file" class="custom-file-input" id="fileToUpload" name="fileToUpload">
                                                    <label class="custom-file-label" for="fileToUpload">Select Image</label>
                                                </div>
                                            </div>
                                        </div>
                                        <script>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-sm-9">
                                                    <input  type="submit" style="color: white;" class="btn btn-primary" value="Upload">
                                                </div>
                                            </div>
                                        </div>
